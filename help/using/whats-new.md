...
description: Obtenga información sobre las nuevas funciones y mejoras de Experience Manager Assets Brand Portal versión 2024.02.0.
...
>[!NOTE]
>
>Ahora todos los usuarios tienen **[!UICONTROL Descarga rápida]** habilitada de manera predeterminada y requiere que IBM® Aspera Connect 3.9.9 (`https://www.ibm.com/docs/en/aspera-connect/3.9.9`) esté instalado en la extensión de su explorador antes de descargar los recursos de Brand Portal.
