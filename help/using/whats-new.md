...
Anteriormente, todas las representaciones de recursos se descargaban directamente en una carpeta zip. Se omitió el cuadro de diálogo **[!UICONTROL Descargar]** para carpetas y colecciones, y no había ningún método para controlar el comportamiento de descarga de los recursos, lo que dificultaba la búsqueda de una representación determinada en muchas descargas.
...
Además de las configuraciones existentes de **[!UICONTROL Descargar]**, los administradores de Brand Portal también pueden configurar opciones para que diferentes grupos de usuarios vean y (o) descarguen el recurso original y sus representaciones desde la página de detalles del recurso.
...
Consulte [configurar la descarga de recursos](https://experienceleague.adobe.com/docs/experience-manager-brand-portal/using/download/brand-portal-download-assets.html#configure-download-permissions).
...
Ver las [notas de la versión de Brand Portal](brand-portal-release-notes.md) más recientes.
...
Brand Portal 6.4.4 y versiones posteriores admiten la búsqueda de texto parcial en el predicado de propiedad en el panel de filtrado. Para permitir la búsqueda de texto parcial, debe habilitar **Búsqueda parcial** en el predicado de propiedad en el formulario de búsqueda.
...
Brand Portal permite usar el asterisco (&#42;) en la consulta de búsqueda junto con una parte de la palabra de la frase buscada.
...
Por ejemplo, si se especifica **climb&#42;**, se devolverán todos los recursos que tengan palabras que comiencen por los caracteres **climb** en la frase de título si el formulario de búsqueda en Brand Portal utiliza el predicado de propiedad para la búsqueda parcial del título de los recursos.
...
Por ejemplo, una organización con el dominio existente **geomettrix.brand-portal.adobe.com** puede crear **geomettrixinc.brand-portal.adobe.com** a petición.

AEM Sin embargo, la instancia de autor de la solo se puede [configurar](https://experienceleague.adobe.com/docs/experience-manager-65/assets/brandportal/configure-aem-assets-with-brand-portal.html?lang=es) con la URL del id de inquilino y no con la URL del alias de inquilino (alternativa).
...
Para habilitar la descarga acelerada basada en IBM Aspera para la organización, los administradores deben seleccionar la opción **Habilitar la aceleración de descarga** (que está deshabilitada de forma predeterminada) en [Configuración general](brand-portal-general-configuration.md#allow-download-acceleration) en el panel de herramientas administrativas. Para obtener más información sobre los requisitos previos y los pasos para solucionar problemas de descarga de archivos de recursos más rápida desde Brand Portal y vínculos compartidos, consulte [Guía para acelerar las descargas desde Brand Portal](../using/accelerated-download.md#main-pars-header).

### Informe de inicios de sesión de usuario

Se ha introducido un nuevo informe, para rastrear los inicios de sesión de los usuarios. El informe **inicios de sesión de usuarios** puede ser fundamental para permitir que las organizaciones auditen y controlen a los administradores delegados y a otros usuarios de Brand Portal.
...
* Se han introducido nuevos métodos abreviados de teclado, por ejemplo _(p)_ para la navegación a la página de propiedades, _(e)_ para la edición y _(ctrl+c)_ para las operaciones de copia.
...
* Nueva capacidad de Assets relacionada que se proporciona en Propiedades del recurso. Assets AEM que están relacionados con otros recursos de origen o derivados en Brand Portal y que se publican en ellos ahora tienen su relación intacta en Brand Portal, con vínculos a los recursos relacionados en la página de propiedades.
...
Los informes de uso ahora se consolidan con otros informes y ahora se pueden ver desde la consola Informes de recursos. Para llegar a la consola Informes de recursos, vaya a **Crear/administrar informes** desde el panel de herramientas administrativas.

![](assets/accessassetreport.png)

**Se ha mejorado la experiencia del usuario con los informes**
...
* Ahora, Assets publicado en Brand Portal AEM desde la versión 6.3.2.1 y la versión 6.4 se puede poner a disposición de los usuarios generales de Brand Portal marcando la casilla de verificación Publish de carpeta pública en el cuadro de diálogo Replicación de AEM Assets Brand Portal.
