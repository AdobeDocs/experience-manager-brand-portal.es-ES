...
>[!NOTE]
>
>Para trabajar con vídeos y publicarlos en Brand Portal, asegúrese de que la instancia de autor de Experience Manager esté configurada en el modo híbrido de Dynamic Media o en el modo **[!DNL Scene7]** de Dynamic Media.
...
* [Configuración de Dynamic Media [!DNL Scene7] 2}
Si la instancia de autor de Experience Manager se está ejecutando en Dynamic Media: modo ](#configure-dm-scene7-settings).
**[!DNL Scene7]**
...
El repositorio de Brand Portal no almacena codificaciones de vídeo y las recupera del servidor **[!DNL Scene7]**. Asegúrese de que las configuraciones de Dynamic Media tanto en la instancia de autor de Adobe Experience Manager como en Brand Portal sean las mismas.
...
* **Iniciar Experience Manager Author en modo Dynamic Media**
  ...
  Inicie la instancia de autor de Experience Manager (con la que está configurado Brand Portal) en [Dynamic Media - [!DNL Scene7] modo](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/assets/dynamic/config-dms7#enabling-dynamic-media-in-scene-mode) o en [Dynamic Media - modo híbrido](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/assets/dynamic/config-dynamic) o

* **Configurar los servicios de nube de Dynamic Media en la instancia de autor de Experience Manager**

  En función del modo Dynamic Media (modo Scene7 o híbrido) en el que se está ejecutando Experience Manager Author, establezca [Dynamic Media Cloud Services ([!DNL Scene7] modo)](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/assets/dynamic/config-dms7#configuring-dynamic-media-cloud-services) o [Dynamic Media Cloud Services (modo híbrido)](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/assets/dynamic/config-dms7#configuring-dynamic-media-cloud-services) en Experience Manager Author desde **Herramientas** | **Servicios de nube** | **Dynamic Media**.

* **Configurar Dynamic Media en Brand Portal**

  En función de las configuraciones de nube de Dynamic Media en Experience Manager Author, configure [Dynamic Media settings](#configure-dm-hybrid-settings) o [[!DNL Scene7] settings](#configure-dm-scene7-settings) desde las herramientas administrativas de Brand Portal.

  Asegúrese de que se usan [inquilinos de Brand Portal](#separate-tenants) independientes para las instancias de Experience Manager Author configuradas en Dynamic Media: modo **[!UICONTROL Scene7]** y Dynamic Media: modo híbrido. Si usa las funcionalidades de Dynamic Media **[!UICONTROL S7]** y Dynamic Media Hybrid, este enfoque es particularmente importante.

* **Publicar carpetas con codificaciones de vídeo aplicadas a Brand Portal**

  Aplique [codificaciones de vídeo](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/assets/dynamic/video-profiles) y publique en Brand Portal la carpeta que contiene los recursos de medios enriquecidos de la instancia de autor de Experience Manager.

* **IP de salida de Lista de permitidos en SPS si la vista previa segura está habilitada**

  Si usa Dynamic Media-**[!DNL Scene7]** (con [vista previa segura habilitada](https://experienceleague.adobe.com/en/docs/dynamic-media-classic/using/upload-publish/testing-assets-making-them-public) para una empresa), se recomienda que **[!DNL Scene7]** administrador de la empresa [lista de permitidos las IP de salida pública](https://experienceleague.adobe.com/en/docs/dynamic-media-classic/using/upload-publish/testing-assets-making-them-public#testing-the-secure-testing-service) para las regiones respectivas mediante la interfaz de usuario Flash de SPS (**[!UICONTROL Scene7]** Publishing System).
  ...
  Para realizar la lista de permitidos de cualquiera de estas direcciones IP de salida, consulte [Preparar su cuenta para un servicio de pruebas seguro](https://experienceleague.adobe.com/en/docs/dynamic-media-classic/using/upload-publish/testing-assets-making-them-public#testing-the-secure-testing-service).
...
Si utiliza las funciones Dynamic Media - modo **[!DNL Scene7]** y Dynamic Media - modo híbrido, utilice diferentes inquilinos de Brand Portal para las instancias de autor de Experience Manager configuradas con Dynamic Media - **[!DNL Scene7]** y Dynamic Media - modos híbridos.


![Asignación uno a uno de autor y BP](assets/BPDynamicMedia.png)

### Mismos detalles de configuración en la instancia de autor de Experience Manager y en Brand Portal

Asegúrese de que los detalles de configuración sean los mismos en Brand Portal y **[!UICONTROL Experience Manager Cloud Configuration]**. Los mismos detalles de configuración incluyen lo siguiente:
...
Si la instancia de autor de Experience Manager se está ejecutando en modo híbrido de medios dinámicos, use el mosaico **[!UICONTROL Vídeo]** del panel de herramientas administrativas para configurar la configuración de la puerta de enlace de Dynamic Media.

>[!NOTE]
>
>Los [perfiles de codificación de vídeo](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/assets/dynamic/video-profiles) no se han publicado en Brand Portal. En su lugar, se recuperan del servidor **[!UICONTROL Scene7]**. Por lo tanto, para que las codificaciones de vídeo se reproduzcan correctamente en Brand Portal, asegúrese de que los detalles de configuración sean los mismos que los [Servicios de nube de Dynamic Media ([!DNL Scene7] modo)](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/assets/dynamic/config-dms7#configuring-dynamic-media-cloud-services) de la instancia de autor de Experience Manager.

Para establecer las configuraciones de Dynamic Media en los inquilinos de Brand Portal:

1. Seleccione el logotipo de Experience Manager para poder acceder a las herramientas administrativas desde la barra de herramientas situada en la parte superior de Brand Portal.
...
1. Especifique **[!UICONTROL ID de registro]** y **[!UICONTROL URL del servicio de vídeo]** (URL de puerta de enlace de DM). Asegúrese de que estos detalles sean los mismos que los de **[!UICONTROL Herramientas > Cloud Services]** en la instancia de autor de Experience Manager.
1. Seleccione **Guardar** para salvar la configuración.

## Configuración de Dynamic Media Scene7 {#configure-dm-scene7-settings}

Si la instancia de autor de Experience Manager se está ejecutando en modo Dynamic Media- **[!UICONTROL Scene7]**, use el mosaico **[!UICONTROL Configuración de Dynamic Media]** del panel de herramientas administrativas para establecer la configuración del servidor **[!UICONTROL Scene7]**.
...
2. En el panel de herramientas administrativas, seleccione el mosaico **[!UICONTROL Configuración de Dynamic Media]**.
   ...
   **[!UICONTROL Editar configuración de Dynamic Media]**.
...
6. Seleccione **[!UICONTROL Restablecer]** para borrar cualquier cambio, restablecer la contraseña y restaurar la configuración a su estado predeterminado.
