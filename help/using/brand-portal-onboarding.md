...
1. En la página de registro, especifique sus detalles (incluidos el nombre, apellidos, contraseña y país o región).
   ...
   >[!NOTE]
   >
   >Si su organización utiliza Enterprise ID, en lugar de ver esta página de registro, se le redirigirá a la página de inicio de sesión de Enterprise. Para obtener más información, consulta [Enterprise ID, inicio de sesión y ayuda para la cuenta](https://helpx.adobe.com/in/enterprise/kb/enterprise-id-faq.html).
