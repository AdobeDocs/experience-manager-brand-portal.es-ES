...
## Qué cambió en 2024.10.0 {#what-changed-in-October-2024}

Brand Portal 2024.10.0 es una versión interna que incluye correcciones a problemas críticos. Ver las [notas de la versión de Brand Portal](brand-portal-release-notes.md) más recientes.

## Qué cambió en 2024.02.0 {#what-changed-in-February-2024}

Brand Portal 2024.02.0 es una versión interna que incluye correcciones a problemas críticos. Ver las [notas de la versión de Brand Portal](brand-portal-release-notes.md) más recientes.

## Qué cambió en 2023.10.0 {#what-changed-in-October-2023}

Brand Portal 2023.10.0 es una versión interna que incluye correcciones a problemas críticos. Ver las [notas de la versión de Brand Portal](brand-portal-release-notes.md) más recientes.

## Qué cambió en la versión 2023.08.0 {#what-changed-in-August-2023}

Brand Portal 2023.08.0 es una versión interna que incluye correcciones a problemas críticos. Ver las [notas de la versión de Brand Portal](brand-portal-release-notes.md) más recientes.

## Qué cambió en 2023.05.0 {#what-changed-in-May-2023}

Brand Portal 2023.05.0 es una versión interna que incluye correcciones a problemas críticos. Ver las [notas de la versión de Brand Portal](brand-portal-release-notes.md) más recientes.

## Qué cambió en 2023.02.0 {#what-changed-in-February-2023}

Brand Portal 2023.02.0 es una versión interna que incluye correcciones a problemas críticos. Ver las [notas de la versión de Brand Portal](brand-portal-release-notes.md) más recientes.

## Qué cambió en 2022.10.0 {#what-changed-in-October-2022}

Brand Portal 2022.10.0 es una versión interna que incluye correcciones a problemas críticos. Ver las [notas de la versión de Brand Portal](brand-portal-release-notes.md) más recientes.

## Qué cambió en 2022.08.0 {#what-changed-in-August-2022}

Brand Portal 2022.08.0 es una versión interna que incluye correcciones a problemas críticos. Ver las [notas de la versión de Brand Portal](brand-portal-release-notes.md) más recientes.

## Qué cambió en 2022.05.0 {#what-changed-in-May-2022}

Ahora, Brand Portal ejecuta trabajos automáticamente cada doce horas para eliminar todos los recursos de Brand Portal AEM que se publican en el sitio de la aplicación de la manera más sencilla y con mayor frecuencia Como resultado, no es necesario eliminar manualmente los recursos de la carpeta Contribution para mantener el tamaño de la carpeta por debajo del límite de umbral. También puede supervisar el estado de los trabajos de eliminación que se ejecutan automáticamente mediante la opción **[!UICONTROL Herramientas]** > **[!UICONTROL Estado de contribución de recursos]** > **[!UICONTROL Informes de eliminación]** en Brand Portal. El informe de un trabajo proporciona los siguientes detalles:
...
Además, Brand Portal 2022.05.0 incluye correcciones a los problemas críticos. Ver las [notas de la versión de Brand Portal](brand-portal-release-notes.md) más recientes.


## Qué cambió en 2022.02.0 {#what-changed-in-Feb-2022}

Brand Portal 2022.02.0 es una versión interna que incluye correcciones a problemas críticos. Ver las [notas de la versión de Brand Portal](brand-portal-release-notes.md) más recientes.

## Qué cambió en 2021.10.0 {#what-changed-in-october-2021}

Brand Portal 2021.10.0 es una versión interna que incluye correcciones a problemas críticos. Ver las [notas de la versión de Brand Portal](brand-portal-release-notes.md) más recientes.
...
* [Presentando perfiles de Adobe](https://helpx.adobe.com/enterprise/kb/introducing-adobe-profiles.html)

* [Administrar perfiles de Adobe](https://helpx.adobe.com/enterprise/using/manage-adobe-profiles.html)

* [Actualización para la experiencia de inicio de sesión para usuarios y administradores](https://helpx.adobe.com/enterprise/using/storage-for-business.html#new-admin-sign-in-exp)
...
* [Administrar usuarios en el Admin Console](https://helpx.adobe.com/enterprise/using/manage-users-individually.html)
...
* [Confianza de dominio](https://helpx.adobe.com/enterprise/admin-guide.html/enterprise/using/set-up-identity.html#directory-trusting)
...
Brand Portal 2021.06.0 es una versión interna que incluye correcciones a problemas críticos. Ver las [notas de la versión de Brand Portal](brand-portal-release-notes.md) más recientes.


## Qué cambió en 2021.02.0 {#what-changed-in-feb-2021}

Brand Portal 2021.02.0 mejora el as a Cloud Service de AEM Assets con el flujo de trabajo de activación y la función de obtención de recursos. También mejora la experiencia de descarga de recursos e incluye correcciones críticas. También permite a los administradores configurar el comportamiento de descarga predeterminado de carpetas, colecciones y descarga masiva de recursos en el nivel de inquilino. El **[!UICONTROL Informe de uso]** de Brand Portal también se ha modificado para reflejar los usuarios activos de Brand Portal.

### Activar Brand Portal en AEM Assets as a Cloud Service {#bp-automation-on-cloud-service}

El as a Cloud Service de AEM Assets ahora puede tener una instancia preconfigurada de Brand Portal. El usuario de Cloud Manager puede activar Brand Portal en la instancia as a Cloud Service de AEM Assets.

Anteriormente, el AEM Assets as a Cloud Service se configuraba manualmente con Brand Portal mediante Adobe Developer Console.

El usuario de Cloud Manager déclencheur el flujo de trabajo de activación que crea las configuraciones necesarias en el backend y activa Brand Portal en la misma organización de IMS que en la instancia as a Cloud Service de AEM Assets.

Para activar Brand Portal en la instancia as a Cloud Service de AEM Assets:

1. Inicie sesión en Cloud Manager de Adobe y navegue hasta **[!UICONTROL Entornos]**.
...
La función de obtención de recursos ya está disponible en AEM Assets as a Cloud Service. La función está habilitada de forma predeterminada para todos los usuarios del servicio en la nube. Los usuarios de Brand Portal autorizados pueden contribuir al abastecimiento de recursos cargando nuevos recursos en las carpetas de contribución y publicando la carpeta de contribución de Brand Portal en la as a Cloud Service instancia de AEM Assets. Los administradores pueden revisar y aprobar las contribuciones de los usuarios de Brand Portal antes de distribuirlas a otros usuarios.

Anteriormente, el abastecimiento de recursos solo estaba disponible en AEM Assets (local y servicio administrado).

Consulte [Abastecimiento de recursos en Brand Portal](https://experienceleague.adobe.com/en/docs/experience-manager-brand-portal/using/asset-sourcing-in-brand-portal/brand-portal-asset-sourcing).
...
Ver [descargar recursos de Brand Portal](https://experienceleague.adobe.com/en/docs/experience-manager-brand-portal/using/download/brand-portal-download-assets).
<!--
...
El **[!UICONTROL informe de uso]** de Brand Portal se ha modificado para reflejar solamente los usuarios de Brand Portal activos. Los usuarios de Brand Portal que no están asignados a ningún perfil de producto en el Admin Console se consideran usuarios inactivos y no se reflejan en el **[!UICONTROL Informe de uso]**.
...
Los administradores de Brand Portal ahora pueden configurar opciones para que los grupos de usuarios vean o descarguen recursos y representaciones originales, o ambos, desde la página de detalles de recursos, además de las configuraciones de **[!UICONTROL Descargar]** existentes.
...
Consulte [configurar la descarga de recursos](https://experienceleague.adobe.com/en/docs/experience-manager-brand-portal/using/download/brand-portal-download-assets#configure-download-permissions).
...
La versión 6.4.7 de Brand Portal incorpora el Visualizador de documentos, mejora la experiencia para descargar recursos e incluye correcciones críticas. Ver las [notas de la versión de Brand Portal](brand-portal-release-notes.md) más recientes.
...
En Brand Portal 6.4.7, los administradores de Brand Portal pueden configurar la configuración del recurso **[!UICONTROL Descargar]**. Las configuraciones disponibles son:
...
En función de la configuración, el flujo de trabajo de descarga permanece constante para los recursos independientes, varios recursos y carpetas que contienen recursos. También incluye recursos con o sin licencia y la descarga de recursos mediante un vínculo compartido.
...
|---|---|---|
| **AEM Assets as a Cloud Service** | [Crear configuración](https://experienceleague.adobe.com/es/docs/experience-manager-cloud-service/content/assets/brand-portal/configure-aem-assets-with-brand-portal) | - |
...
>[!NOTE]
>
>Adobe AEM recomienda actualizar la instancia de para utilizar el Service Pack más reciente.

Ver [Notas de la versión de Brand Portal](brand-portal-release-notes.md).

Ver [preguntas más frecuentes sobre Brand Portal](brand-portal-faqs.md).
...
AEM La fuente de recursos permite a los usuarios de la (administradores o no administradores) crear carpetas con una propiedad adicional de **Contribución de recursos**, lo que garantiza que la nueva carpeta creada esté abierta al envío de recursos por parte de los usuarios de Brand Portal. Almacena en déclencheur automáticamente un flujo de trabajo que crea dos subcarpetas adicionales, llamadas NEW y SHARED, dentro de la carpeta **Contribution** recién creada.

AEM El usuario carga de manera predeterminada recursos breves y de línea de base en la carpeta **SHARED**. Definen los tipos de recursos necesarios en la carpeta de contribución, lo que garantiza que los usuarios de Brand Portal tengan la información de referencia necesaria. El administrador puede otorgar a los usuarios activos de Brand Portal acceso a la carpeta de contribuciones antes de publicar la carpeta **Contribution** recién creada en Brand Portal.


AEM Una vez que el usuario haya terminado de agregar contenido en la carpeta **NEW**, podrá volver a publicar la carpeta Contribution en el entorno de autor de la. La importación puede tardar unos minutos en completarse y reflejar el contenido recién publicado en AEM Assets.
...
>
>AEM AEM Esta función no es compatible con las versiones anteriores, es decir, la versión 6.3 y la versión 6.4 de la.
...
### Carpeta de contribución de Publish a AEM Assets {#publish-assets-to-aem}

Una vez que la carga se haya completado en la carpeta **NEW**, los usuarios de Brand Portal AEM podrán volver a publicar la carpeta Contribution en la carpeta de. La importación y el reflejo del contenido o los recursos publicados en AEM Assets pueden tardar unos minutos. Ver [publicar carpeta de contribución en AEM Assets](brand-portal-publish-contribution-folder-to-aem-assets.md).
...
La versión 6.4.4 de Brand Portal se centra en las mejoras en la búsqueda de texto y en las solicitudes de los clientes principales. Ver las [notas de la versión de Brand Portal](brand-portal-release-notes.md) más recientes.
...
Brand Portal 6.4.3 introduce un alias alternativo para las direcciones URL de acceso, una nueva jerarquía de carpetas y mejoras en la compatibilidad con vídeo. AEM También introduce la publicación programada desde Autor de la aplicación a Brand Portal, las mejoras operativas y aborda las solicitudes de los clientes.

### Navegación de jerarquía de carpetas para no administradores

Los administradores ahora pueden configurar cómo se muestran las carpetas a los usuarios no administradores (editores, visualizadores y usuarios invitados) al iniciar sesión. La configuración de [Habilitar jerarquía de carpetas](../using/brand-portal-general-configuration.md) se ha agregado en **Configuración general**, en el panel de herramientas de administración. Si la configuración es:
...
El predicado **Path Browser** se ha introducido en el formulario de búsqueda para permitir la búsqueda de recursos en un directorio específico. La ruta de búsqueda predeterminada del predicado de búsqueda para el explorador de rutas es `/content/dam/mac/<tenant-id>/`, que se puede configurar editando el formulario de búsqueda predeterminado.
...
AEM Los usuarios cuya instancia de autor de la esté en modo híbrido de Dynamic Media pueden obtener una vista previa de las representaciones de medios dinámicos y descargarlas, además de los archivos de vídeo originales.
...
El flujo de trabajo de publicación de Assets AEM (y carpetas) desde la instancia de autor de la versión 6.4.2.0 de a Brand Portal se puede programar para una fecha y hora posteriores.
...
AEM Sin embargo, la instancia de autor de la solo se puede [configurar](https://experienceleague.adobe.com/es/docs/experience-manager-65/content/assets/brandportal/configure-aem-assets-with-brand-portal) con la URL del identificador de inquilino y no con la URL del alias de inquilino (alternativa).
...
Brand Portal 6.4.2 y versiones posteriores utilizan la interfaz OAuth heredada (`https://legacy-oauth.cloud.adobe.io/`) para crear la aplicación JWT, lo que permite configurar las integraciones de OAuth para permitir la integración de AEM Assets con Brand Portal. Anteriormente, la interfaz de usuario para configurar integraciones de OAuth se alojaba en `https://marketing.adobe.com/developer/`. Para obtener más información sobre la integración de AEM Assets con Brand Portal para publicar recursos y colecciones en Brand Portal, consulte [Configuración de la integración de AEM Assets con Brand Portal](https://experienceleague.adobe.com/es/docs/experience-manager-65/content/assets/brandportal/configure-aem-assets-with-brand-portal).
...
Sin embargo, la búsqueda sin distinción entre mayúsculas y minúsculas es comparativamente más lenta que la búsqueda predeterminada de Predicado de propiedad. Si hay demasiados predicados que no distinguen entre mayúsculas y minúsculas en el filtro de búsqueda, la búsqueda puede ralentizarse. El Adobe recomienda utilizar la búsqueda sin distinción entre mayúsculas y minúsculas con prudencia.

## Cambios en 6.4.1 {#what-changed-in-2}

Brand Portal 6.4.1 es una versión de actualización de plataforma. Incorpora varias funciones nuevas y mejoras fundamentales, como mejoras de exploración, búsqueda y rendimiento.
...
* Nueva capacidad de Assets relacionada que se proporciona en Propiedades del recurso. Los recursos relacionados publicados en Brand Portal AEM desde ahora mantienen sus relaciones, con vínculos a estos recursos relacionados disponibles en la página de propiedades de.
...
Se ha introducido un nuevo informe, para proporcionar información sobre los vínculos compartidos. El informe Compartir vínculos enumera todas las direcciones URL de los recursos compartidos con usuarios internos y externos. Informa para usuarios de toda la organización en el lapso de tiempo especificado. También informa de cuándo se compartió el vínculo, quién lo compartió y cuándo caduca.
...
Cada uno de los informes que se están creando se puede personalizar añadiendo o eliminando columnas predeterminadas. Además, se pueden añadir columnas personalizadas a los informes Descargar, Caducidad y Publish para controlar su grado de granularidad.
...
* Ahora, Assets publicado en Brand Portal AEM desde la versión 6.3.2.1 y la versión 6.4 se puede poner a disposición del público marcando la casilla Publish de carpeta pública en el cuadro de diálogo Replicación de AEM Assets Brand Portal.

![](assets/public-folder-publish.png)

* Los administradores reciben una notificación a través de los correos electrónicos de solicitud de acceso, excepto en las notificaciones del área de notificación de Brand Portal, si alguien ha solicitado acceso a Brand Portal.
...
Para obtener más información, consulte la [notificación de mantenimiento de Brand Portal](https://experienceleague.adobe.com/en/docs/experience-manager-brand-portal/using/introduction/brand-portal).
...
### Cambios de marca del Experience Cloud {#experience-cloud-branding-changes}
...
Para alinear la experiencia del usuario de Brand Portal AEM con la de los, el Adobe está realizando la transición a la interfaz de usuario de Coral 3. Este cambio mejora la capacidad de uso general, incluida la navegación y la apariencia.
...
Después de descargar una carpeta anidada, puede conservar la jerarquía de carpetas original. Assets dentro de una carpeta anidada se puede descargar en una sola carpeta, en lugar de en carpetas independientes.
...
* AEM Los administradores de pueden publicar el esquema de metadatos de AEM Assets en Brand Portal AEM utilizando la versión 6.3 SP 1-CFP 1 (6.3.1.1), disponible en el cuarto trimestre de 2017.
